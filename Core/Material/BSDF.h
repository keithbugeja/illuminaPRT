...
namespace Illumina
{
	namespace Core
	{
		...
		public:
			...
			virtual Spectrum SampleF(const DifferentialSurface& p_surface, const Vector3 &p_wOut, Vector3 &p_wIn, float p_u, float p_v, float *p_pdf);
			virtual Spectrum F(const DifferentialSurface& p_surface, const Vector3 &p_wOut, const Vector3 &p_wIn);
