...
namespace Illumina
{
	namespace Core
	{
		...
		public:
			ImageDevice(const std::string &p_strName, int p_nWidth, int p_nHeight, bool p_bTimeStamp, IImageIO *p_pImageIO, const std::string &p_strFilename, bool p_bKillFilterOnExit = false);
			ImageDevice(int p_nWidth, int p_nHeight, bool p_bTimeStamp, IImageIO *p_pImageIO, const std::string &p_strFilename, bool p_bKillFilterOnExit = false);
			~ImageDevice(void);
