...
namespace Illumina 
{
	namespace Core
	{
		...
		public:
			KDTreeMesh(int p_nMaxObjectsPerLeaf = 5 /*10*/ /*16*/, int p_nMaxTreeDepth = 35 /*30*/);
			KDTreeMesh(const std::string &p_strName, int p_nMaxObjectsPerLeaf = 5 /*10*/ /*16*/, int p_nMaxTreeDepth = 35 /*30*/);
