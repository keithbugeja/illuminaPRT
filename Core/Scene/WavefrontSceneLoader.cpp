...
{ }
//----------------------------------------------------------------------------------------------
bool WavefrontSceneLoader::Import(const std::string &p_strFilename, Environment *p_pEnvironment, Flags p_generalFlags = Scene, unsigned int p_uiLoaderFlags)
{
}
//----------------------------------------------------------------------------------------------
bool WavefrontSceneLoader::Export(const std::string &p_strFilename, Environment *p_pEnvironment, Flags p_generalFlags = Scene, unsigned int p_uiLoaderFlags)
{
}
//----------------------------------------------------------------------------------------------
