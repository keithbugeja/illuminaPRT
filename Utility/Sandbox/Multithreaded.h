...
protected:
	...
	RadianceBuffer 
		*m_pRadianceTemporalBuffer,
		*m_pRadianceAccumulationBuffer,
		*m_pRadianceBuffer, 
		*m_pRadianceBufferChain[2];
...
public:
	...
	void Render(void)
	{
		...
		//----------------------------------------------------------------------------------------------
		RenderThread::RenderThreadState renderThreadState(m_pRenderer, m_pRadianceBuffer, m_nSize, m_nSize, m_nThreadCount + 1, m_fFrameBudget);
